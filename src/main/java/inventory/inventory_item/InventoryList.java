...
import inventory.inventory_menu_use_case.delete_item_use_case.DeleteItemDsGateway;
 ...
 *
 */
public class InventoryList implements AddItemDsGateway,
        PlayerDisplayInventoryDsGateway,
        DeleteItemDsGateway,
        InitializePlayerInventoryGateway {
    ...
    /**
     * Add new inventory_item to the inventory
   ...
   @Override
    ...
    /**
     * Check how many inventory_item are in the inventory
