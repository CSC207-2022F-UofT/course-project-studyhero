...
class StatsUserTest {
    ...
    public void setUp() {
        ...
        this.statsMap = new HashMap<String, Integer>();
    }
    @Test
    ...
    void testStatsUserLoadedConstructorSetsRightValues() {
        ...
        assertTrue(loadedStats.level == 12 && loadedStats.hp == 10 &&
                loadedStats.gold == 102 && loadedStats.damage == 5 && loadedStats.defence == 1);
    }
    @Test
